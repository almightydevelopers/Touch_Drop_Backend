...
class ConfigController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->map_api_key = "AIzaSyCxTDUAFNGp0Dz4ES-IseB-Qq4h57K34lo";
    }
    ...
    public function geocode_api(Request $request)
    {
        ...
        // return response()->json(['status' => 1,'message' => 'https://maps.googleapis.com/maps/api/geocode/json?latlng='.$request->lat.','.$request->lng.'&key='.$this->map_api_key], 200);
        return $response->json();
    }
